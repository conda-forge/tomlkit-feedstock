...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=2085&branchName=main">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/tomlkit-feedstock?branchName=main">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `tomlkit` can be installed with `conda`:
...
```
mamba install tomlkit
```

It is possible to list all of the versions of `tomlkit` available on your platform with `conda`:
...
```
mamba search tomlkit --channel conda-forge
```
...
mamba repoquery search tomlkit --channel conda-forge

# List packages depending on `tomlkit`:
mamba repoquery whoneeds tomlkit --channel conda-forge

# List dependencies of `tomlkit`:
mamba repoquery depends tomlkit --channel conda-forge
```
